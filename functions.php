...
function return_project_card($card_wrap, $base_folder, $slug, $project_name, $portfolio,$portfolio_slug, $status, $launch_date, $project_description, $jira_ticket, $include_link, $include_edit, $record_id){
	$status=set_style_to_status($status, "");
	$launch_date=trim_display_date($launch_date);
	$jira_ticket=check_jira_ticket($jira_ticket);
	...
	$project_card=$project_card."<tr><td class='status_bar'>".$status."&nbsp;&nbsp;<strong>".$portfolio_link."</strong>&nbsp;&nbsp;".$launch_date."&nbsp;&nbsp;".$jira_ticket."&nbsp;&nbsp;| ".$edit_link."</td></tr>";
