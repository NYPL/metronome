        ...
        <div id="content" class="site-content" role="main">
            <article id="post-1" class="post-1 post type-post status-publish format-standard hentry category-uncategorized">
                ...
                <header class="entry-header">
                    ...
                    $t_description = $simple["Template Description"];
                ...
                <div class="entry-content">
                    ...
                    // usage: AirPressQuery($tableName, CONFIG_ID or CONFIG_NAME)
                    $query2 = new AirpressQuery("Templates to Projects LookUp", CONFIG_NAME);
                    $query2->filterByFormula("{Template}='$temp_title'");
                    $used_in_projects = new AirpressCollection($query2);
                    $used_in_projects->populateRelatedField("Project", "Projects");
                    $used_in_projects->populateRelatedField("Project|Project State", "Project Status");
                    ...
                    // usage: AirPressQuery($tableName, CONFIG_ID or CONFIG_NAME)
                    $query = new AirpressQuery("Component to Template LookUp", CONFIG_NAME);
                    $query->filterByFormula("{Template}='$T_Name'");
                    $query->sort("Order", "asc");
                    $components = new AirpressCollection($query);
                    // connect related fields (Column, Table)
                    $components->populateRelatedField("Component", "Components");
                    // Breaks my brain
                    ...
                    foreach ($components as $e) {
                        ...
                        $C_Accessibility = $e["Component"][0]["Accessibility"];
                        $C_Func_Specs = $e["Component"][0]["FunctionalSpecs"];
                        ...
                        $number = $e["Order"];
                        $C_Manual_or_Auto = return_page_placement_type($e["Manual or Auto"]);
                        ...
                        $C_Slug = $e["Component"][0]["Slug"];

                        $C_Description = $e["Component"][0]["ComponentDescription"];
                        $C_Accessibility = $e["Component"][0]["Accessibility"];
                        $C_Func_Specs = $e["Component"][0]["FunctionalSpecs"];

                        $these_parameters = return_my_parameters($e["Component"][0]);
                        $optional = $e["Manual or Auto"];
